...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `https://picsum.photos/seed/1/800/600`, text: 'AC Service' },
      { image: `https://picsum.photos/seed/2/800/600`, text: 'Fridge Repair' },
      { image: `https://picsum.photos/seed/3/800/600`, text: 'Gas Refilling' },
      { image: `https://picsum.photos/seed/4/800/600`, text: 'Installation' },
      { image: `https://picsum.photos/seed/5/800/600`, text: 'Deep Cleaning' },
      { image: `https://picsum.photos/seed/6/800/600`, text: 'LED TV Repair' },
    ];
  ...
  addEventListeners() {
    ...
    // Wheel ONLY on container — prevents page scroll from triggering gallery scroll
    this.container.addEventListener('mousewheel', this.boundOnWheel, { passive: true });
    this.container.addEventListener('wheel', this.boundOnWheel, { passive: true });
    // Drag on window so you can drag even if cursor leaves container
...
export default function CircularGallery({ items, bend = 3, textColor = '#ffffff', borderRadius = 0.05, font = 'bold 30px Figtree', fontUrl, scrollSpeed = 2, scrollEase = 0.05 }) {
  ...
  // items is GALLERY_ITEMS — a stable module-level constant, so this runs once
